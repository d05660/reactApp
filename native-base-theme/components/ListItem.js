  ...
  const listItemTheme = {
    ...
    ".icon": {
      ...
      "NativeBase.Body": {
        ...
        height: 44,
        justifyContent: "center",
        borderBottomWidth: platform === "ios" ? 1 / PixelRatio.getPixelSizeForLayoutSize(1) : null,
        borderColor: variables.listBorderColor
      },
      "NativeBase.Right": {
        "NativeBase.Text": {
    ...
    marginLeft: variables.listItemPadding + 5,
    borderBottomWidth: platform === "android" ? 1 / PixelRatio.getPixelSizeForLayoutSize(1) : null,
